  ...
  return (
    <Box as="section" sx={styles.section} variant="section.introVideo">
      <Container>
        <SectionHeading
          sx={styles.heading}
          title="Leading companies trust us to develop most efective solutions with our talent team"
          description="From ecommerce websites, to enterprise level intranets, our solutions have helped companies enter and thrive the digital age. Your organization can take the first step by contacting us today."
        />
