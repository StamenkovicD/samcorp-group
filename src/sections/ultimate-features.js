    ...
    <Box as="section" id="ultimate-feature" variant="section.ultimateFeature">
      <Container>
        <SectionHeading
          ...
          description="We are passionate about designing and building great solutions that solve a vast array of problems. And all our solutions are based on great community-powered foundations."
        />
