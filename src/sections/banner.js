        ...
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.content}>
            ...
            <Text as="p" sx={styles.text}>
              With a combined experience of over 100 years, ohfocorp is paving the way for organizations to maximize their roi by using open source solutions with a proven track record.
            </Text>
